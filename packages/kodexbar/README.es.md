...
KodexBar Suite es un monitor de cuotas de IA para KDE Plasma 6 y Linux. Ofrece un resumen compacto configurable en el panel y un popup completo para Claude Code, OpenAI Codex, Cursor, Grok, OpenCode Go, Hermes, Devin, Antigravity y otros proveedores devueltos por la [CLI CodexBar](https://github.com/steipete/CodexBar). Los créditos restantes de Hermes salen del login local de Nous Portal. Los porcentajes restantes de Devin salen del login local de Devin. También incluye un visor opcional de modelos locales y un inventario de skills entre proveedores.
...
- Muestra una cuenta de proveedor a la vez, ordenada como Codex, Claude, Grok, Antigravity, Cursor, Hermes, Devin y después todos los demás proveedores habilitados.
- Mantiene separadas las cuentas repetidas con ordinales estables no sensibles en pestañas y salida compacta.
- Usa los SVG suministrados de Codex, Claude, Grok, Cursor, Hermes, Devin, Antigravity y Gemini, y mantiene distintas las identidades de Antigravity y Gemini.
...
- Usa `codex,claude,grok,antigravity,opencodego,hermes,devin` como valor predeterminado.
...
Después agrega **KodexBar Suite** a un panel de Plasma si todavía no está presente.
...
Esto elimina el paquete que ocupe ese identificador, ya sea KodexBar Suite o el widget KodexBar upstream.
...
| Compact providers | Identificadores ordenados y separados por comas que usa la bandeja del sistema. Los chips visibles cubren los proveedores devueltos, como Codex, Claude, Grok, Antigravity, Cursor, OpenCode Go, Hermes y Devin. Vacío muestra todos los proveedores devueltos y nunca filtra el popup. |
