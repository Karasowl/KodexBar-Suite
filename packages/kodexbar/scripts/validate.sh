...
if command -v qmllint >/dev/null 2>&1; then
    qmllint contents/code/providerLogic.js contents/code/themePalette.js contents/ui/main.qml contents/ui/PreferencesWindow.qml contents/ui/ThemedMark.qml
else
